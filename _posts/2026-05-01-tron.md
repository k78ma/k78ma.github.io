---
layout: distill
title: UWaterloo Tron - Review + Advice
description: Tron was not a mistake!
tags: school
...
toc:
  ...
  - name: Academics
    subsections:
        - name: Curriculum
        - name: Courseload and difficulty
        - name: Do grades even matter?
        - name: Exchange
        - name: Transfers
        - name: Dropping out
  - name: Co-op
...
<div style="display: flex; flex-direction: column; align-items: center; margin-top: 1rem;">
  <div style="max-width: 500px; width: 100%;">
    {% include figure.html path="assets/img/1B-schedule.png" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="caption" style="text-align: center; font-size: 0.98rem; margin-top: 0.1rem;">
    Scary-looking 1B timetable.
  </div>
</div>
...
## Research
Undergraduate research is not as popular at Waterloo in the math/CS and engineering departments as other schools (due to Waterloo's heavy industry focus), but does still exist. It primarily occurs in two forms:
1. [Undergraduate Research Assistantships (URAs)](https://uwaterloo.ca/engineering/undergraduate-students/degree-enhancement/research-opportunities/ura) are part-time research opportunities with professors during school terms.
2. There are full-time research co-op positions posted by university labs (both at Waterloo and at other schools), or by research organizations (such as the National Research Council), or by research-focused companies.

Let's talk about URAs first. They generally require you to be in your 2A term and have at least an 80% in your previous academic term. Typically, you just have to email a professor that you're interested in working with who has indicated that they are open to taking URAs. You typically get a \\$1000 stipend for the term, or \\$1500 if you are eligible for the [President's Research Award](https://uwaterloo.ca/engineering/undergraduate-students/scholarships-and-awards/presidents-research-award). 

I am not a big fan of URAs. I think that doing good research requires a large amount of dedicated time and effort, which the part-time structure of the URA does not really provide. Of course, you can squeeze out more time for research by spending less time on classes; for example, see Rose Wang's [blog on undergraduate research](https://rosewang2008.github.io/blog/2021/01/03/undergrad-research-advice.html#prob_b), where she intentionally took low-commitment classes. However, this is hard to do at Waterloo engineering because you mostly don't get to pick your classes, and also have to balance job-hunting for the upcoming co-op term. Thus, most URAs end up being fairly low-commitmment, which means that you don't really do any actual meaningful research work; most people just get an extra line or two on their resume, which can still be useful but usually is not all that valuable. The vast majority of people do not get a publication out of a URA.

Outside of URAs, the other common option is full-time research as a co-op. This has the benefit of high time commitment, making it much closer to "real" research that academics do (although your projects will still limited by the short time frame of a 4 month co-op, whereas a PhD student has 5 years). The higher commitment means you are much more likely to produce meaningful, publishable research; my first co-op was a research position and I ended up with 3 first-author papers, which was a huge boost to my resume. One downside of research co-ops however is that they generally do not pay a ton, often being reliant on grants for funding, and might not be a big resume boost unless you are interested in graduate school or research-heavy fields. For example, if your goal is to be a software engineer, generally having research experience is not as valuable as industry internships. Thus, I would mostly recommend research co-ops if:
- You're early in your career (1st and 2nd co-ops)
- You want to go into a research-heavy field (machine learning, biotech, etc.)
- The professor/researcher you are working with is well-respected and well-connected
- The project you are working on is cool
- You have the opportunity to publish
- You are want to try out research to see if you are interested in graduate school (PhD or research-based Masters)
...
If you have a Waterloo offer and an offer to one of these schools, I don't think it's an easy decision to make; these schools often have more clout, and for good reason. However, do keep in mind what I said before: Waterloo provides the same opportunities, especially in the tech, and its world ranking is still decent. It will also cost much less. Thus, the decision is still ultimately just up to your personal circumstances and desires.

Note that I strongly believe (obviously massively biased so take this with a grain of salt) that Waterloo is the best engineering school in Canada. I'm not saying Waterloo is some magical thing that will automatically grant you a good career; if you're very smart, you can find a way to succeed anywhere. If you're dumb, it's not like Waterloo can't save you either. My opinion is just that, on average, Waterloo will provide you with the most opportunities to succeed, as the chance to do 6 co-ops reduces reliance on luck, and you will be surrounded by smart people. If you really love research, maybe UofT EngSci is a better choice, although I would argue that you can just do research co-op terms at Waterloo. If you really value a pretty campus, UBC is fine too. Canadian engineering education in general is fairly solid, it's not like choosing something other than Waterloo will automatically cause you to fail.

## Personal statistics
Below I've compiled some numbers and statistics from my time in Waterloo for the curious to see.
### Academics
Grade averages per term:
<div style="display: flex; flex-direction: column; align-items: center; margin-top: 0.1rem;">
  <div style="max-width: 600px; width: 100%;">
    {% include figure.html path="assets/img/averages.png" class="img-fluid rounded z-depth-1" %}
  </div>
</div>

- Lowest grade: MTE 119 (64), Highest grade: MTE 241 (100)
- My grades were lowest in 1B and 2A. This was mostly because I was more focused on trying to secure good co-op positions, as getting good co-ops early obviously has a positive compounding effect. There were also some personal extenuating circumstances in 1B that caused lower grades (co-op got rescinded last minute). Thus, I would not say that 1B and 2A were especially hard terms, just that I wasn't focused on school at all at the time.
- My grades were highest in 4A and 4B. This was mostly because I did not need to spend much time searching for a full-time job (got a return offer and only bothered interviewing for a few other companies), and because I chose somewhat easier technical electives. My GPA was also really close to the 87 cut-off for graduating with [Dean's Honours](https://uwaterloo.ca/academic-calendar/undergraduate-studies/catalog#/policy/H1M5x8946?q=honours&itemTypes=policies&limit=20&skip=0&bc=true&bcCurrent=Awards%20of%20Excellence&bcItemType=policies) so I figured I might as well lock in and try to get it, although it doesn't really matter for anything. Note that 4A and 4B are not necessarily easier than other terms either; it depends on the electives you take and your capstone project.
- The hardest term is probably 3B, since there are a lot of technical courses and MTE 381, a project course that can end up being a lot of work. However, I did 3B on exchange (hence why it's N/A on the plot), so I don't really know for sure.
...
- [Alex Rodrigues](https://www.linkedin.com/in/rodriguesalex/)
- [Clayton Haight](https://clayhaight.com/index.html)
- [Ethan Childerhose](https://www.linkedin.com/in/ethan-childerhose/), [Owen Brake](https://www.linkedin.com/in/owenbrake/)
- [Sanjeevani Lakshmivarahan](https://www.linkedin.com/in/sanjlakshmi/)
- [Matt Rendall](https://www.linkedin.com/in/matthewrendall/), [Ryan Gariepy](https://www.linkedin.com/in/rgariepy/)
...
- [How to Do Great Work](https://www.paulgraham.com/greatwork.html), [Superlinear Returns](https://www.paulgraham.com/superlinear.html)
